...
//    public ArrayList<Object> getListObject(String key, List<Music> mClass){
//    	Gson gson = new Gson();
//
...
//    		Object value  = gson.fromJson(jObjString, (Type) mClass);
//    		objects.add(value);
//    	}
//    	return objects;
//    }
...
//    }
//
//    public void putListObject(String key, List<Music> objArray){
//    	checkForNullKey(key);
//    	Gson gson = new Gson();
